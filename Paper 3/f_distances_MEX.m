...
function results=f_distances_MEX(spikes,d_para,f_para)

%spikes = spikes';
%spikes = spikes(1:250, :);

max_memo_init=1000000000;      % memory management, should be big enough to hold the basic matrices but small enough to not run out of memory
